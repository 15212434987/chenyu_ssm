...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<li><a href="${pageContext.request.contextPath}/sysLog/findAll?searchValue=${sv}&pageNum=${pageInfo.pages}&pageSize=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
						</ul>
					</div>
	...
	<script>
        ...
        function search() {
            ...
            location.href = "${pageContext.request.contextPath}/sysLog/findAll?pageNum=${pageInfo.pageNum}&pageSize=${pageInfo.pageSize}&searchValue="+str
        }
        ...
        function changePageSize() {
            ...
            //向服务器发送请求，改变没页显示条数
            location.href = "${pageContext.request.contextPath}/sysLog/findAll?searchValue=${sv}&pageNum=1&pageSize="
                + pageSize;
        }
