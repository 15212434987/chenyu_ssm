					...
					<tbody>
						<c:forEach var="traveller" items="${orders.travellers}">
							...
							<tr>
								...
								<td><input type="text" size="10" class="form-control" value="${traveller.name }"
									readonly="readonly"></td>
								<td><input type="text" size="10" class="form-control" value="${traveller.sex }"
									readonly="readonly"></td>
								<td><input type="text" size="20"
									value="${traveller.phoneNum }" class="form-control" readonly="readonly"></td>
								<td><input type="text" size="15"
									value="${traveller.credentialsTypeStr}" class="form-control" readonly="readonly"></td>
								<td><input type="text" size="28"
									value="${traveller.credentialsNum }" class="form-control" readonly="readonly"></td>
							</tr>
						</c:forEach>
